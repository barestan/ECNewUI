    ...
    <div class="e-detail item-row" :class="{'is-mobile': isMobile}" >
        <div class="item-info" >
            <div class="item-info-panel">
                <div>
                    <div class="toolbar">
                        <button  class="btn btn-m btn-primary" v-if="isMobile" v-on:click="$parent.collapsed = !$parent.collapsed">
                            &lt;  Return to list
                        </button>
                        <button  class="btn btn-m btn-outline-info" v-on:click="copyTextToClipboard"  title="Copy error">
                            <i class="fa fas fa-copy"></i>
                        </button>
                        <a type="button" class="btn btn-m btn-outline-info" target="_blank" :href="(elmah_root || '/elmah') +'/xml?id='+id" title="Download as XML">
                            <span>xml</span>
                        </a>
                        <a type="button" class="btn btn-m btn-outline-info" target="_blank" :href="(elmah_root || '/elmah') + '/json?id='+id" title="Download as JSON">
                            <span>json</span>
                        </a>
                        <a type="button" class="btn btn-m btn-outline-info" target="_blank" :href="(elmah_root || '/elmah') + '/detail/'+id" title="Open in new window">
                    ...
                    <div class="item-header">
                        <div class="item-subheader">
                            ...
                            <h6 class="text-info">{{item.type}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item-details">
                    ...
                    <div class="request-info">
                        <div class="os">
                            <svg v-if="item.os ==='Windows'" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="50px" height="60px"
                            ...
                            <svg v-if="item.os ==='Linux'" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="50px" height="60px"
                            ...
                            <svg v-if="item.os ==='Macintosh'" version="1.1" viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50px" height="60px">
                            ...
                            <svg v-if="item.os ==='iPhone'" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"  width="50px" height="60px"
                            ...
                            <svg v-if="item.os ==='Android'" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"  width="50px" height="60px"
                                 viewBox="0 0 553.048 553.048" style="enable-background:new 0 0 553.048 553.048;"
                                 xml:space="preserve">
                                <g>
                                    <g>
                        ...
                        <div class="browser">
                            <svg v-if="item.browser ==='Chrome'"  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"  width="50px" height="60px"
                                 viewBox="0 0 305 305" style="enable-background:new 0 0 305 305;" xml:space="preserve">
                                <g id="XMLID_16_">
            ...
            <div class="col-xs-12 alert alert-success msdn"  v-if="helpHtml && helpHtml.html">
        ...
        <div class="item-additions">
            <b-tabs v-model="selectedTab">
                <b-tab v-if="item.sources && item.sources.length > 0" title="Source">
                    <template v-for="(code, key) in item.sources">
                        <div v-bind:key="key" class="sources">
                            <div class="source-line">
                                at <span class="type">{{code.type}}</span>.<span class="method">{{code.function}}</span>() in
                                <span class="filename">{{code.fileName}}</span>(<span class="line">{{code.line}}</span>)
                            </div>
                            <highlight-code class='src-code' lang="csharp">
                                {{code.preContextCode + '\n'}}
                                {{code.contextCode + '// Error in this line at ' + code.fileName +' (' +
                                code.line+') \n '}}
                    ...
                    <b-tab key='stack' v-if="item.htmlMessage" title="Stack Trace">
...
<script>
    ...
    export default {
        ...
        watch: {
            item: function(){
                this.helpHtml = null;
                if ((this.item.type || this.item.statusCode == 0) && this.item.type.toLowerCase() !== 'http') {
                    axios
